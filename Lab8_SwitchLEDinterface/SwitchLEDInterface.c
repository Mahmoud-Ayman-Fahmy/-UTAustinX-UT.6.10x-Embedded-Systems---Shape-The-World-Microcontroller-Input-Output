...
unsigned long volatile delay;// ***** 2. Global Declarations Section *****

// FUNCTION PROTOTYPES: Each subroutine defined
void DisableInterrupts(void); // Disable interrupts
void EnableInterrupts(void);  // Enable interrupts
void Init_function(void);
void delay_fun(unsigned long x);
...
void Init_function(void)
{
  ...
  GPIO_PORTE_DIR_R |= 0x02;         // PE4 output// 1
  GPIO_PORTE_DIR_R &= ~0x01;        // PE2,1,0 input//0
